...
const meals = [
  {
    ...
    instructions: `
      ...
      3. Assemble the burger:
         Toast the burger bun halves. Place lettuce, tomato, and the cooked patty on the bottom half. Add cheese on top of the patty.
  ...
  },
  {
    ...
    instructions: `
      ...
      2. Prepare cheese sauce:
         In a saucepan, melt butter, add flour, and gradually whisk in milk until smooth. Stir in grated cheese until melted.
  ...
  },
  {
    ...
    summary: 'Crispy, golden Wiener Schnitzel, a classic Austrian dish made from tender veal.',
    instructions: `
      1. Prepare the veal:
...
console.log('✅ Baza danych została utworzona i wypełniona przykładowymi danymi!');